...
namespace GameJam.Plugins.Audio.Winds
{
    ...
    public class RangedAudioSource
    {
        ...
        [SerializeField] private float _volumeShift = 1;
        [SerializeField] private float _pitchShift = 1;
        ...
        {
            _source.volume = _volume.Evaluate(normalizedForce) * _volumeShift;
            _source.pitch = _pitch.Evaluate(normalizedForce) * _pitchShift;
        }
    }
}