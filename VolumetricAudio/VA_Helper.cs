...
namespace GameAssets.VolumetricAudio
{
	public static partial class VA_Helper
	{
		...
		public static bool GetListenerPosition(ref Vector3 position)
		{
			...
			{
				position = cachedAudioListener.transform.position;
				return true;
			}
		...
		{
			return Zero(b) == false ? MathUtility.SafeDivision(a, b) : 0.0f;
		}

		public static float Reciprocal(float v)
		{
			return Zero(v) == false ? MathUtility.SafeDivision(1, v) : 0.0f;
		}
